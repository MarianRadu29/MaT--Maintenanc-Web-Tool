...
public class InventoryController {
    ...
    public static class GetInventory implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            JSONArray jsonArray = new JSONArray();
            String sqlStatement = "SELECT i.id, i.name, i.category, i.quantity, i.price, i.supplier, i.status, c.name AS category_name " +
    ...
    public static class AddItem implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            String sqlStmtInsert = "INSERT INTO inventory (name, category, quantity, price, supplier, status) VALUES (?, ?, ?, ?, ?, ?)";
